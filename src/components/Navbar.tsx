...
export const Navbar: React.FC<{ id: string, type: string, localOverrides: any, currentLang?: string, isPreview?: boolean }> = ({ id, type, localOverrides, currentLang = 'en', isPreview = true }) => {
